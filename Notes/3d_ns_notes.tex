...
\newcommand{\bfomegahat}[1]{\hat{\mathbf{\omega}}_{ \mathbf{#1} } }								% gradient operator
...
\title{\textbf{Phase Dynamics: 3D Navier Stokes System}}
...
\section{The Navier Stokes Equations} % (fold)
\label{sec:the_navier_stokes_equations}

We begin with the Navier Stokes equations

\begin{align}
	\pder{\bfu}{t} + \left(\bfu \cdot \nabla \right)\bfu = - \grad{p} + \nu \nabla^2\bfu + f
\end{align}

% section the_navier_stokes_equations (end)
